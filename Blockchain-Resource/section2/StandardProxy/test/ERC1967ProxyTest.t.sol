...
contract ERC1967ProxyTest is Test {
  ...
  function test_ERC1967_avoid_storage_collision() public {
    ...
    // );
      // proxyWalletV2 = MultiSigWalletV2(address(walletV2));
      proxy.upgradeToAndCall(address(walletV2), abi.encodeWithSelector(walletV2.v2Initialize.selector, [alice, bob, carol]));
